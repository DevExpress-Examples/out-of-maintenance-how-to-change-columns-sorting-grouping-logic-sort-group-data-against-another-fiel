...
Namespace WindowsApplication1
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class InvoicesDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddInvoicesRow(ByVal ProductName As String, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Single, ByVal ExtendedPrice As Decimal) As InvoicesRow
...
Namespace WindowsApplication1.nwindDataSetTableAdapters
	...
	Partial Public Class InvoicesTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ProductName, UnitPrice, Quantity, Discount, ExtendedPrice FROM Invoices"
